...
function Thumbnail({ result }) {
  ...
  return (
    <div
      className="group p-2 cursor:pointer transition duration-200
    ...
    >
      ...
      <div className="p-2">
        ...
        <p
          className="flex items-center text-transform: uppercase 
                tracking-widest opacity-0 group-hover:opacity-100"
        >
          {result.media_type && `${result.media_type} `}&bull;{" "}
